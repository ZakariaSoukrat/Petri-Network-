...
public class ImportAction extends AbstractAction {
    ...
    public ImportAction(final Root root, final List<FileType> fileTypes) {
    	super();
        this.root = root;
        this.fileTypes = fileTypes;
        String name = "Import...";
        putValue(NAME, name);
        putValue(SMALL_ICON, GraphicsTools.getIcon(PNEConstantsConfiguration.IMPORT));
	...
	public void actionPerformed(final ActionEvent e) {
        if (!this.root.isModified() || JOptionPane.showOptionDialog(
            ...
            if (chooser.showDialog(this.root.getParentFrame(), "Import") == JFileChooser.APPROVE_OPTION) {
